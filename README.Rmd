...
my_data <- data.frame(
  Recording = c("60 hours", "7.5 hours"),
  `Sample rate`= "96000 Hz",
  Downsampled = "441000 Hz",
  Channels = "Mono",
  `Run time` = c("1.76 hours", "14.52 minutes" )
)

pander::pandoc.table(my_data, style="rmarkdown", "Run times, notebook ~ Intel i5-4210M, 2 cores ~ 8 GB RAM")
```
